...
export const services: Service[] = [
  ...
  },
  {
    ...
    prompt: "Become your sector’s go-to source.",
    summary: "Get found in search and cited in AI answers. Build a sector-focused publication that turns your expertise into visibility.",
    formats: "System setup · Setup + ongoing support",
    headline: "Become the source your sector finds—and AI cites.",
    introduction: "When buyers search your sector or ask AI for answers, your expertise should be part of what they find. We build content systems designed to earn search rankings, AI citations, and an audience you own—with a focused publication your team can run.",
    audience: "B2B companies, specialist publishers, and marketing teams ready to build authority in a defined sector—from energy to AI and beyond.",
    outcomes: ["Visibility on the topics your buyers research, through SEO and AI search (GEO)", "A growing library of useful, source-backed content under your brand", "Consistent publishing with editorial control and a lean team"],
    tiers: [
      {
        name: "System setup & handover",
        format: "One-time engagement",
        description: "Your own sector-focused publishing operation, ready for your team to run. We turn your expertise into a plan for getting found, then build the system to deliver it.",
        deliverables: ["Target topics and buyer questions mapped to your sector", "Source-backed research, brand voice, and editorial approval", "Publishing setup with SEO and AI discoverability built in", "Search and citation measurement, documentation, and operator training"],
      },
      {
        name: "Setup + ongoing support",
        format: "Build + continued involvement",
        description: "Launch your publication, then keep building its visibility. We maintain the system and use performance data to help you decide where to expand and improve coverage.",
        deliverables: ["Everything in System setup & handover", "Search-ranking and AI-citation reviews", "Coverage opportunities and content improvements based on results", "Technical maintenance and editorial workflow refinements"],
      },
    ],
    examplesTitle: "Make your expertise the answer buyers find.",
    examples: [
      { title: "Show up before the sales conversation", description: "Cover the questions, comparisons, and developments your buyers research. Give them a reason to discover your brand before they shortlist a supplier." },
      { title: "Become a source AI can cite", description: "Publish clear, well-sourced answers that AI systems can find and reference. Measure citations alongside search rankings to see where your expertise is showing up." },
      { title: "Give your audience a reason to return", description: "Build useful sector coverage, guides, and reference resources. Where it serves your audience, add a tracker or directory that makes complex information easier to use." },
      { title: "Grow coverage without growing a newsroom", description: "Keep your team focused on expertise and editorial judgment. Let the system support research, drafting, publishing, and adaptation for newsletters and social channels." },
    ],
    steps: [
      { title: "Choose the ground to win", description: "Define your sector, the buyers you want to reach, and the questions you can answer better. Agree on coverage priorities and success measures." },
      { title: "Launch your publishing operation", description: "Connect research, drafting, editorial review, and publishing around your voice and sources. Build in search accessibility and performance measurement from the start." },
      { title: "Build on what gets found", description: "Review rankings, citations, and reader response. Improve existing content and expand coverage where there is demand, with your team or our ongoing support." },
    ],
    faqs: [
      ...
      { question: "What are SEO and GEO, and why do we need both?", answer: "SEO helps people find you in search results. GEO—generative engine optimization—helps AI answer engines find and cite your content. Together, they put your expertise in front of people researching your sector, whether they search for a page or ask for an answer." },
      { question: "How quickly can we see results?", answer: "By September 19, 2026, Nuclear News Network, launched July 9, had earned 10.2k AI citations and 45.3k Google + Bing impressions. DeAI News at deai.org, launched August 29, had earned 2.5k AI citations and 2.6k Google + Bing impressions. Those are early results from our own publications. Your timeline depends on competition, the site’s starting point, content quality, and coverage; we agree on targets and measure progress rather than promise a fixed ranking or citation count." },
      ...
      { question: "Is this only for news publishers?", answer: "No. The same approach can support a B2B resource hub, a specialist industry publication, or a library of buyer guides. We choose the format around what your audience needs and what your business wants to be known for." },
    ],
  },
];
