...
export const services: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How quickly can we see results?", answer: "Our July 9 launch, Nuclear News Network, reached 7.2k AI citations and 25.3k Google impressions by mid-September 2026. DeAI.org, launched August 29, recorded over 1.1k AI citations in roughly two weeks. Those are early results from our own publications. Your timeline depends on competition, the site’s starting point, content quality, and coverage; we agree on targets and measure progress rather than promise a fixed ranking or citation count." },
