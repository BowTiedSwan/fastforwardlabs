...
export const homeContent = {
  ...
  introduction: "Find the right opportunities, automate the busywork, and give your team the skills to use AI well. We advise, build, and train, from your first conversation to ongoing AI leadership.",
};

export const introBookingUrl = "https://cal.com/fast-forward-labs/15min";
...
export function introBookingHref(placement: IntroPlacement): string {
  return withUtm(introBookingUrl, {
    utm_source: "website",
    utm_medium: "cta",
