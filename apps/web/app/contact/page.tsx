...
export const metadata: Metadata = {
  ...
  description: "Tell Fast Forward Labs about your automation, AI training, content system, or advisory needs. Send a project inquiry or book a 15-minute intro call.",
};
  ...
  return (
    <div className="site-shell grid gap-10 py-12 md:py-16 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
      <div className="space-y-6">
        ...
        <div className="mt-8 border-t border-line pt-7"><h2 className="text-xl font-medium">Prefer a quick introduction?</h2><p className="mt-3 text-sm leading-7 text-muted">Book 15 minutes to tell us about your business and explore the next step.</p><Link href={introBookingHref("contact")} {...trackProps("cta", "contact", "intro_booking")} className="mt-3 inline-flex min-h-11 items-center gap-3 border-b border-accent text-sm font-medium">Book an intro call <ArrowUpRight aria-hidden="true" className="size-4" /></Link></div>
      </div>
